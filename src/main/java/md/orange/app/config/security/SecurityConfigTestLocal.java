...
import static md.orange.app.constants.RequestMappings.ALL_MATCHING;
...
import md.orange.app.config.security.authorization.JwtToUserConverter;
import md.orange.app.util.KeyUtils;
...
@Slf4j
public class SecurityConfigTestLocal {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        .authorizeHttpRequests((authorize) -> authorize
            .antMatchers(AUTH_ROOT + ALL_MATCHING).permitAll()
            .antMatchers(HEALTH_CHECK_ROOT).permitAll()
            .antMatchers(SERVICE_ENDPOINTS).permitAll()
