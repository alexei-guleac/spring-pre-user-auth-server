...
import md.orange.app.constants.LoggingConstants;
import md.orange.app.controller.app.healthcheck.HealthCheckController;
...
import md.orange.app.util.StringUtils;
...
@Component
@Slf4j
public abstract class LoggingBaseImpl extends AbstractLogging implements
    LoggingCommon {
  ...
  @Override
  @Pointcut("execution(public   * md.orange.app.controller..*(..))")
   ...
   */
  @Override
  @Pointcut("execution(public   * md.orange.app.service..*(..))")
   ...
   */
  @Override
  @Pointcut("execution(public   * md.orange.app.repository..*(..))")
  ...
  public void beforeControllerExecutionAdvice(JoinPoint joinPoint) {
    ...
    if ((headers.containsKey(AUTH.toLowerCase()) || headers.containsKey(AUTH) || headers
      ...
      userId = jwtUtil.getSubFormJWT(auth);
    }
